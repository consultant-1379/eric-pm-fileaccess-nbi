...
#
# Script taken from: https://gerrit.ericsson.se/gitweb?p=OSS-PROTO/com.ericsson.oss/fenrir-tools.git;a=blob_plain;f=va-reporting-tools/va_report_analyser.py;h=b41bca2a72ef5ca486f08afbc7c1150910eea9ad;hb=aa569bd763c360c8cdd0f1ef4ee82739745a482d
# One change made to the above script to include medium vulnerabilities
#
...
Extracts Medium, High and Critical severity vulnerability entries from the
...
class Report:
  ...
  def _parse_vulnerabilities(self) -> None:
    with open(self._file, mode="r", encoding="utf8") as f:
      summary_pattern = "^\|(c\d+|h\d+|m\d+)\|(critical|high|medium)\|(.+?)\|.*"
...
if __name__ == "__main__":
  parser = argparse.ArgumentParser(description = "Vulnerability Analysis (VA) report analyzer script",
                                   epilog = "Extracts Medium, High and Critical severity vulnerability entries from \
  ...
  parser.add_argument("-e", "--exit-code",
                      ...
                      help="Exit code of the va_report script. If provided, and the value is \
                            ...
                            5 - return 5 indicating that new Critical/High/Medium vulnerability found. \
